    ...
    Widget renderYearButton(date) {
      return new IgnorePointer(
        ...
        child: new _DateHeaderButton(
          ...
          child: new Semantics(selected: mode == DatePickerMode.year, child: new Text(localizations.formatYear(date), style: yearStyle)),
        ),
      );
    }
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          ...
          decoration = new BoxDecoration(color: themeData.accentColor.withOpacity(0.1), shape: BoxShape.rectangle);
        } else if (disabled) {
...
class _MonthPickerState extends State<MonthPicker> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _chevronOpacityController = new AnimationController(duration: const Duration(milliseconds: 250), vsync: this);
  ...
  Widget build(BuildContext context) {
    ...
    return new ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final TextStyle? itemStyle = isSelected ? themeData.textTheme.headline5!.copyWith(color: themeData.colorScheme.secondary) : style;
        return new InkWell(
